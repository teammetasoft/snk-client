...
import { Image, Upload, Button, Input, Select } from 'antd';
        ...
        <>
            <div className="flex flex-col lg:flex-row gap-4 md:gap-6">
                ...
                <div className="w-full lg:w-2/3 space-y-4 p-4 md:p-5 rounded-lg border">
                    <h1 className='text-darkGray text-xl font-semibold mb-4 md:mb-6'>Basic Information</h1>
                    ...
                    <div>
                        ...
                        />
                        <div className="text-right text-sm text-gray-500 mt-1">{description.length} / 100</div>
                    </div>
